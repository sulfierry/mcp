...
RULES: list[tuple[str, list[str]]] = [
    ...
    ("cheminformatics",    ["rdkit", "datamol", "molfeat", "descriptor", "featuriz", "smiles", "substructure", "fragment", "chembl", "pubchem", "zinc-database", "unichem", "molecular-language-models"]),
    ("drug-discovery",     ["admet", "medchem", "sar-", "docking", "diffdock", "autodock", "virtual-screen", "target-", "drug-", "pharm-", "modern-ai-docking"]),
    ("structural-biology", ["alphafold", "esm", "pdb-", "emdb", "struct-predict", "structure-", "binding-site", "viennarna", "plannotate", "boltz-structure-prediction", "alphafold-suite", "chai-1-rosettafold", "rfdiffusion-design", "proteinmpnn-suite", "protein-language-models"]),
    ("mol-dynamics",       ["mdanalysis", "molecular-dynamics", "gromacs", "openmm", "openmm-modern-md", "free-energy-calculations"]),
    ...
    ("ml-framework",       ["pytorch", "torch-", "sklearn", "scikit-", "transformers", "pymc", "stable-baselines", "lightning", "bayesian", "xgboost", "umap", "shap", "pytdc", "genetic-algorithms", "multi-objective-optimization", "pymoo", "pufferlib", "qiskit", "cirq", "qutip", "pennylane", "model-curation", "model-validation", "jax-ecosystem"]),
    ...
    ("architecture",       ["architect", "c4-", "domain-driv", "event-sourcing", "cqrs", "saga-orchestr", "microservice", "monorepo-arch", "architecture-decision", "architecture-pattern", "distributed-systems-frontier"]),
    ("agent-orchestration",["agent-orchestr", "multi-agent", "orchestrator", "planning-", "executing-plan", "task-", "dispatching-parallel"]),
    ("llm-rag",            ["llm-", "rag-", "prompt-engineer", "embedding", "hybrid-search", "mcp-", "claude-api", "langchain", "lora-peft-finetuning", "llm-inference-servers", "llm-quantization"]),
    ("seo",                ["seo-"]),
