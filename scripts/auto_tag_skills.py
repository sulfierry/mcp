...
RULES: list[tuple[str, list[str]]] = [
    ...
    ("ml-framework",       ["pytorch", "torch-", "sklearn", "scikit-", "transformers", "pymc", "stable-baselines", "lightning", "bayesian", "xgboost", "umap", "shap", "pytdc"]),
    ...
    ("langs",              ["python-pro", "python-arch", "python-perform", "async-python", "bash-", "posix-shell", "golang-pro", "go-concur", "rust-pro", "rust-async", "rust-engineer", "cpp-pro", "c-pro", "c-systems", "csharp-", "dotnet-", "java-pro", "scala-", "ruby-pro", "elixir-", "php-", "julia-", "haskell-", "matlab", "minecraft-bukkit", "typescript-", "javascript-pro", "modern-javascript"]),
    ...
    ("devops-infra",       ["docker", "kubernetes", "k8s-", "terraform", "helm-", "istio", "linkerd", "mesh", "bazel", "nx-", "turborepo", "gitops", "github-actions", "gitlab-", "ci-cd", "cicd", "prometheus", "grafana", "observability", "slo-", "sre-", "cloud-arch", "multi-cloud", "hybrid-cloud", "deployment", "monorepo", "serverless", "conductor-", "saga-"]),
    ...
    ("testing",            ["tdd-", "test-driven", "testing-", "test-generate", "webapp-test", "e2e-test", "performance-test", "javascript-test", "python-test", "bats-test"]),
    ...
    ("claude-tooling",     ["claude-", "mcp-builder", "mcp-develop", "skill-creator", "tool-design", "hosted-agents", "subagent-"]),
